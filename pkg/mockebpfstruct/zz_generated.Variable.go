...
// Done provides a mock function for the type MockVariable
func (_mock *MockVariable[T]) Done() <-chan struct{} {
	ret := _mock.Called()
...
// MockVariable_Done_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Done'
type MockVariable_Done_Call[T any] struct {
	*mock.Call
}

// Done is a helper method to define mock.On call
func (_e *MockVariable_Expecter[T]) Done() *MockVariable_Done_Call[T] {
	return &MockVariable_Done_Call[T]{Call: _e.mock.On("Done")}
}

func (_c *MockVariable_Done_Call[T]) Run(run func()) *MockVariable_Done_Call[T] {
...
func (_c *MockVariable_Done_Call[T]) Return(valCh <-chan struct{}) *MockVariable_Done_Call[T] {
	_c.Call.Return(valCh)
	return _c
}

func (_c *MockVariable_Done_Call[T]) RunAndReturn(run func() <-chan struct{}) *MockVariable_Done_Call[T] {
	_c.Call.Return(run)
	return _c
}
